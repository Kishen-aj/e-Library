...
namespace e_Library.WebUI.Controllers
{
    public class BasketController : Controller
    {
        ...
        [HttpPost]
        [Authorize]
        public ActionResult Checkout(Order order,PreOrder preorder)
        {
            ...
            return RedirectToAction("ThankYou", new { OrderId = order.Id, PreOrderId = preorder.Id });
        }
        ...
        public ActionResult Payment(decimal FinalTotal)
        {
            ...
            //localhost
                url = "https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_xclick&amount=" + (fTotal) + "&business=peakylibrary@outlook.com&item_name=Books&return=https://localhost:44349/Basket/ThankYou/";
            //deployed
               // url = "https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_xclick&amount=" + (fTotal) + "&business=JanjuaTailors@Shop.com&item_name=Books&return=https://2021grp09.azurewebsites.net/Basket/ThankYou";
